...
import org.iitg.mobileprofiler.mobilecore.ClassifierService;
import org.iitg.mobileprofiler.mobilecore.FeatureComputationService;
import org.iitg.mobileprofiler.mobilecore.MobileProfilerService;
...
public class MainActivity extends Activity {
	...
	public void MenuClick(View v){
		...
		case R.id.ll_btn_b1:
			...
			intent = new Intent(this, Question_Act.class);
			startActivity(intent);
			break;
			
		case R.id.ll_btn_b2:
			Log.v(TAG,"Getting feedback for questions asked.");
			intent = new Intent(this, MyList2.class);
			startActivity(intent);
			break;
		...
		case R.id.btn_c2:
			...
			intent = new Intent(this, Response.class);
			startActivity(intent);
			break;
		}
	}
